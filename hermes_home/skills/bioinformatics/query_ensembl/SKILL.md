...
when_to_use: "[query_ensembl] Query the Ensembl REST API using natural language or a direct endpoint."
version: 1.0.0
author: MemOmics
license: MIT
...
When you need query ensembl analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `prompt` | [Required] Natural language query about genomic data (str) | |
| `endpoint` | [Optional] Direct Ensembl endpoint or full URL | |
