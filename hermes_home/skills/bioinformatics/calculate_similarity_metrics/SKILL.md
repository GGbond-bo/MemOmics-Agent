...
Calculate similarity metrics between two medical images. Supports mutual information, mean squared error, correlation, and normalized cross correlation.

## When to Use

When you need calculate similarity metrics analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `image1_path` | [Required] Path to the first image file (str) | |
| `image2_path` | [Required] Path to the second image file (str) | |
