...
when_to_use: "[design_golden_gate_oligos] Design complementary oligonucleotides with Type IIS restriction enzyme overhangs for Golden Gate assembly based on restriction site analysis of the backbone."
version: 1.0.0
author: MemOmics
license: MIT
...
When you need design golden gate oligos analysis
...
| `insert_sequence` | [Required] Sequence to be inserted (e.g., sgRNA target sequence) (str) | |
