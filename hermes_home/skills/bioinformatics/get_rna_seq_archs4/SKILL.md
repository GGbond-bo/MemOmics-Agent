...
when_to_use: "[get_rna_seq_archs4] ARCHS4基因表达查询：输入基因名→跨组织/细胞类型RNA-seq表达谱"
version: 1.0.0
author: MemOmics
license: MIT
...
When you need get rna seq archs4 analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `gene_name` | [Required] The gene name for which RNA-seq data is being fetched (str) | |
| `K` | [Optional] The number of tissues to return (default: 10) | |
