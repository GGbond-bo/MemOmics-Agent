...
when_to_use: "[analyze_abr_waveform_p1_metrics] Extracts P1 amplitude and latency from Auditory Brainstem Response (ABR) waveform data."
version: 1.0.0
author: MemOmics
license: MIT
...
When you need analyze abr waveform p1 metrics analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `time_ms` | [Required] Time points of the ABR recording in milliseconds (array-like) | |
| `amplitude_uv` | [Required] Amplitude values of the ABR recording in microvolts (array-like) | |
