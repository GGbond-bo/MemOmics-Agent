...
Open Targets Platform GraphQL API查询。靶点-疾病-药物关联

分析步骤:
  - GraphQL query build: Target-disease association query
  - Target prioritization: Genetic + functional scoring
  - Network visualization: Target-disease network graph

触发提示: "查询Open Targets靶点-疾病关联"

## When to Use

当你需要 Open Targets GraphQL API 时触发

## Pipeline

1. **GraphQL query build**
   - Target-disease association query
   - Tool: `terminal`
2. **Target prioritization**
   - Genetic + functional scoring
   - Tool: `terminal`
3. **Network visualization**
   - Target-disease network graph
   - Tool: `terminal`
...
|-----------|---------|-------|
| `steps` | GraphQL query build -> Target prioritization -> Network visualization | |
