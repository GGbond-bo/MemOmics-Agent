...
when_to_use: "[ppt-generator] PPT演示文稿自动生成：内容大纲→专业幻灯片设计→图表/排版/配色→汇报级PPT文件"
version: 1.0.0
author: MemOmics
license: MIT
...
AI驱动的PPT生成系统，支持16:9暗色主题，自动布局，图表插入

分析步骤:
  - 内容规划: 根据输入内容规划PPT结构和页面
  - 生成PPT: 使用python-pptx生成16:9暗色主题PPT
  - 质量检查: 检查页面布局、文字溢出、图表位置
