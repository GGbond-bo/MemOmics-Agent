...
when_to_use: "[calculate_physicochemical_properties] 分子理化性质计算：化合物SMILES→分子量/logP/HBD/HBA/TPSA→类药五规则评估"
version: 1.0.0
author: MemOmics
license: MIT
...
When you need calculate physicochemical properties analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `smiles_string` | [Required] The molecular structure in SMILES format (str) | |
