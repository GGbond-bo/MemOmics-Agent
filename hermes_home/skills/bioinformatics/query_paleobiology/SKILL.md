...
when_to_use: "[query_paleobiology] Query the Paleobiology Database (PBDB) API using natural language or a direct endpoint."
version: 1.0.0
author: MemOmics
license: MIT
...
When you need query paleobiology analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `prompt` | [Required] Natural language query about fossil records (str) | |
| `endpoint` | [Optional] API endpoint name or full URL | |
