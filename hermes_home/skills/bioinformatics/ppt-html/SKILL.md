...
when_to_use: "[ppt-html] HTML演示文稿生成：内容框架→HTML5幻灯片→reveal.js→可转PPT→交互展示"
version: 1.0.0
author: MemOmics
license: MIT
...
图文并茂的HTML文献报告生成，支持9项结构化总结+Figure展示

适用场景: 文献解读后生成HTML报告

依赖包: jinja2, PyMuPDF, Pillow

难度: beginner

触发提示: "生成HTML报告"

别名: 生成HTML报告, HTML报告, 文献HTML
