...
Align short sequences (primers) to a longer sequence, allowing for one mismatch. Checks both forward and reverse complement strands.

## When to Use

When you need align sequences analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `long_seq` | [Required] Target DNA sequence (str) | |
| `short_seqs` | [Required] Single primer or list of primers (Union[str, List[str]]) | |
