...
when_to_use: "[analyze_bone_microct_morphometry] 骨微CT形态计量：microCT扫描→骨小梁参数(BV/TV/Tb.Th/Tb.N/Tb.Sp)→骨质疏松评估"
version: 1.0.0
author: MemOmics
license: MIT
...
# Analyze Bone Microct Morphometry

Analyze bone microarchitecture parameters from 3D micro-CT images to calculate bone mineral density, bone volume, trabecular number, thickness, and separation.

## When to Use

When you need analyze bone microct morphometry analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `input_file_path` | [Required] Path to the micro-CT scan data file (TIFF stack or similar 3D format) (str) | |
| `output_dir` | [Optional] Directory to save output files (default: ./results) | |
| `threshold_value` | [Optional] Threshold value for bone segmentation. If None, Otsu's method will be used | |
