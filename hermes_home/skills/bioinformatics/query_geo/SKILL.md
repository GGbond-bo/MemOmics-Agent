...
when_to_use: "[query_geo] Query the NCBI GEO database (GDS/GEOPROFILES) using natural language or direct search term."
version: 1.0.0
author: MemOmics
license: MIT
...
When you need query geo analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `prompt` | [Required] Natural language query about expression data (str) | |
| `search_term` | [Optional] Direct GEO search term | |
