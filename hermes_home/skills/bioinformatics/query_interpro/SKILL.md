...
when_to_use: "[query_interpro] Query the InterPro REST API using natural language or a direct endpoint."
version: 1.0.0
author: MemOmics
license: MIT
...
When you need query interpro analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `prompt` | [Required] Natural language query about protein domains/families (str) | |
| `endpoint` | [Optional] Endpoint path or full URL | |
| `max_results` | [Optional] Max results per page (default: 3) | |
