...
when_to_use: "[perform_flux_balance_analysis] Perform Flux Balance Analysis (FBA) on a genome-scale metabolic network model and return a research log of the process and results."
version: 1.0.0
author: MemOmics
license: MIT
...
Perform Flux Balance Analysis (FBA) on a genome-scale metabolic network model and return a research log of the process and results.

## When to Use

When you need perform flux balance analysis analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `model_file` | [Required] Path to the metabolic model file (SBML or JSON format) (str) | |
| `constraints` | [Optional] Dictionary of reaction constraints where keys are reaction IDs and values are tuples of (lower_bound, upper_bound) | |
| `objective_reaction` | [Optional] Reaction ID to use as the objective function (e.g., biomass reaction) | |
| `output_file` | [Optional] File name to save the flux distribution results (default: fba_results.csv) | |
