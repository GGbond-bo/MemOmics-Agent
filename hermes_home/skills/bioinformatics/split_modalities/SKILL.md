...
Split a 4D NIfTI file into separate modality files for nnUNet processing. Handles BRATS dataset format with FLAIR, T1w, t1gd, and T2w modalities.

## When to Use

When you need split modalities analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `input_file` | [Required] Path to the 4D NIfTI file to split (str) | |
| `output_dir` | [Required] Directory to save the split modality files (str) | |
| `case_name` | [Optional] Base name for the case files (default: BRAT) | |
