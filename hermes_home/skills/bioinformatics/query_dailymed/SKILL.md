...
when_to_use: "[query_dailymed] Query the DailyMed RESTful API using natural language or a direct endpoint."
version: 1.0.0
author: MemOmics
license: MIT
...
When you need query dailymed analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `prompt` | [Required] Natural language query about drug labeling (str) | |
| `endpoint` | [Optional] Direct DailyMed endpoint or full URL | |
