...
Create and save visualization of segmentation results using nilearn. Generates overlay plots and multiple anatomical views.

## When to Use

When you need create segmentation visualization analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `original_mri` | [Required] Path to original MRI file (str) | |
| `segmentation` | [Required] Path to segmentation file (str) | |
| `output_dir` | [Optional] Directory to save visualization images (default: ./visualization_output) | |
