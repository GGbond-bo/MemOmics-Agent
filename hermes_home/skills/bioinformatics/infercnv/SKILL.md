...
inferCNV肿瘤细胞CNV推断+恶性细胞鉴定

分析步骤:
  - Create inferCNV object: Tumor + normal reference
  - CNV inference: run + CNV heatmap
  - Malignant cell ID: Classify by CNV level
...
1. **Create inferCNV object**
   - Tumor + normal reference
   - Tool: `terminal`
2. **CNV inference**
   - run + CNV heatmap
   - Tool: `terminal`
3. **Malignant cell ID**
   - Classify by CNV level
   - Tool: `terminal`
...
|-----------|---------|-------|
| `steps` | Create inferCNV object -> CNV inference -> Malignant cell ID | |
