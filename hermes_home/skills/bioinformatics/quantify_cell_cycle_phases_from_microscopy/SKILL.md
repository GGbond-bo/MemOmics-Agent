...
when_to_use: "[quantify_cell_cycle_phases_from_microscopy] Quantify the percentage of cells in each cell cycle phase using Calcofluor white stained microscopy images."
version: 1.0.0
author: MemOmics
license: MIT
...
When you need quantify cell cycle phases from microscopy analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `image_paths` | [Required] List of file paths to microscopy images of cells stained with Calcofluor white (List[str]) | |
| `output_dir` | [Optional] Directory to save results (default: ./results) | |
