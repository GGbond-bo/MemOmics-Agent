...
when_to_use: "[query_remap] Query the ReMap database for regulatory elements and transcription factor binding."
version: 1.0.0
author: MemOmics
license: MIT
...
When you need query remap analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `prompt` | [Required] Natural language query about TF binding sites (str) | |
| `endpoint` | [Optional] Full API endpoint to query | |
