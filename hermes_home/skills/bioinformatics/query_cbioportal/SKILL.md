...
when_to_use: "[query_cbioportal] Query the cBioPortal REST API using natural language or a direct endpoint."
version: 1.0.0
author: MemOmics
license: MIT
...
When you need query cbioportal analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `prompt` | [Required] Natural language query about cancer genomics (str) | |
| `endpoint` | [Optional] API endpoint path or full URL | |
