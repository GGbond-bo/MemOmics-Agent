...
Finds common restriction enzyme sites in a DNA sequence and returns their cut positions.

## When to Use

When you need find restriction enzymes analysis
...
| `is_circular` | [Optional] Whether the sequence is circular (default: False) | |
