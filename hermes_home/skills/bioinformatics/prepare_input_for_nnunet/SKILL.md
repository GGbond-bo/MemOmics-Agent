...
Prepare input data for nnUNet by handling both 4D and pre-split modality files. Automatically detects file format and prepares data accordingly.

## When to Use

When you need prepare input for nnunet analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `input_path` | [Required] Path to input file or directory (str) | |
| `output_dir` | [Required] Directory to save prepared files (str) | |
