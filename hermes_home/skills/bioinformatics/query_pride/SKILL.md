...
when_to_use: "[query_pride] Query the PRIDE proteomics database using natural language or a direct endpoint."
version: 1.0.0
author: MemOmics
license: MIT
...
When you need query pride analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `prompt` | [Required] Natural language query about proteomics data (str) | |
| `endpoint` | [Optional] Full endpoint to query | |
