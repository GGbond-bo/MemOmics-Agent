...
# Analyze Cytokine Production In Cd4 Tcells

Analyze cytokine production (IFN-γ, IL-17) in CD4+ T cells after antigen stimulation.

## When to Use

When you need analyze cytokine production in cd4 tcells analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `fcs_files_dict` | [Required] Dictionary mapping stimulation conditions to FCS file paths. Expected keys: 'unstimulated', 'Mtb300', 'CMV', 'SEB' (dict) | |
| `output_dir` | [Optional] Directory to save the results file (default: ./results) | |
