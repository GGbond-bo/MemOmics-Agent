...
# 细胞通讯分析 (CellChat v2) — Proven Analysis Script
...
# Step 2: L-R interaction inference
# Step 3: Signal flow visualization
# Step 4: Comparison (multi-condition)
# Step 5: Source-target summary
