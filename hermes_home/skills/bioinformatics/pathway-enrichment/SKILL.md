...
**CRITICAL for condition comparisons:** When comparing enriched pathways between conditions, you MUST:
...
3. Avoid pooling up and down genes together
...
When a question asks about "immune-relevant", "cancer-related", or similar pathways:
1. Run enrichment on **all** pathways first
2. Examine **all** significantly enriched pathways
3. Determine relevance from biological function, not keywords

### WARNING: Do NOT Use Keyword Matching

Do not use keyword matching to include or exclude pathways. Many biologically relevant pathways do not contain the obvious domain words in their names.
