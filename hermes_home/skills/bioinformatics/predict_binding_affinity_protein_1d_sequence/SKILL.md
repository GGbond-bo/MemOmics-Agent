...
when_to_use: "[predict_binding_affinity_protein_1d_sequence] Predicts binding affinity between small molecules and a protein sequence using pre-trained deep learning models."
version: 1.0.0
author: MemOmics
license: MIT
...
# Predict Binding Affinity Protein 1D Sequence

Predicts binding affinity between small molecules and a protein sequence using pre-trained deep learning models.

## When to Use

When you need predict binding affinity protein 1d sequence analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `smiles_list` | [Required] List of SMILES strings representing chemical compounds (List[str]) | |
| `amino_acid_sequence` | [Required] Protein sequence in amino acid format (str) | |
| `affinity_model_type` | [Optional] Deep learning model architecture to use for binding affinity prediction (options: CNN-CNN, MPNN-CNN, Morgan-CNN, Morgan-AAC, Daylight-AAC) (default: MPNN-CNN) | |
