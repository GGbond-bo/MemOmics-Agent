...
when_to_use: "[analyze_intracellular_calcium_with_rhod2] Analyzes intracellular calcium concentration using Rhod-2 fluorescent indicator from microscopy images."
version: 1.0.0
author: MemOmics
license: MIT
...
# Analyze Intracellular Calcium With Rhod2

Analyzes intracellular calcium concentration using Rhod-2 fluorescent indicator from microscopy images.

## When to Use

When you need analyze intracellular calcium with rhod2 analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `background_image_path` | [Required] Path to the background image (no cells, just media) (str) | |
| `control_image_path` | [Required] Path to the control image (cells without calcium stimulus) (str) | |
| `sample_image_path` | [Required] Path to the sample image (cells with calcium stimulus) (str) | |
