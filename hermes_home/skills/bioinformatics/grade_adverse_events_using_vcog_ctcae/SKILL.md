...
when_to_use: "[grade_adverse_events_using_vcog_ctcae] Grade and monitor adverse events in animal studies using the VCOG-CTCAE standard."
version: 1.0.0
author: MemOmics
license: MIT
...
When you need grade adverse events using vcog ctcae analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `clinical_data_file` | [Required] Path to a CSV file containing clinical evaluation data with columns: subject_id, time_point, symptom, severity, measurement (optional) (str) | |
