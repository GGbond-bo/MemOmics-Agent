...
when_to_use: "[get_bacterial_transformation_protocol] Return a standard protocol for bacterial transformation."
version: 1.0.0
author: MemOmics
license: MIT
...
# Get Bacterial Transformation Protocol

Return a standard protocol for bacterial transformation.

## When to Use

When you need get bacterial transformation protocol analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `antibiotic` | [Optional] Selection antibiotic (default: ampicillin) | |
| `is_repetitive` | [Optional] Whether the sequence contains repetitive elements (default: False) | |
