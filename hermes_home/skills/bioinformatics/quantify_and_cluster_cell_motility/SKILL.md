...
when_to_use: "[quantify_and_cluster_cell_motility] Quantify cell motility features from time-lapse microscopy images and cluster cells based on motility patterns."
version: 1.0.0
author: MemOmics
license: MIT
...
When you need quantify and cluster cell motility analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `image_sequence_path` | [Required] Path to directory containing time-lapse microscopy images in sequential order (str) | |
| `output_dir` | [Optional] Directory to save output files (default: ./results) | |
| `num_clusters` | [Optional] Number of motility pattern clusters to identify (default: 3) | |
