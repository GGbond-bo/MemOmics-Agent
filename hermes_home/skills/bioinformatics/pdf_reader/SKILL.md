...
读取 PDF 论文，提取正文、图表、表格、元数据，支持批量处理和 Markdown 转换

分析步骤:
  - PDF parsing (PyMuPDF): Extract text + tables + figures
  - Structured output: Organize by section/paragraph
...
|-----------|---------|-------|
| `steps` | PDF parsing (PyMuPDF) -> Structured output | |
