...
when_to_use: "[query_unichem] Query the UniChem 2.0 REST API using natural language or a direct endpoint."
version: 1.0.0
author: MemOmics
license: MIT
...
When you need query unichem analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `prompt` | [Required] Natural language query about chemical cross-references (str) | |
| `endpoint` | [Optional] Direct UniChem endpoint or full URL | |
