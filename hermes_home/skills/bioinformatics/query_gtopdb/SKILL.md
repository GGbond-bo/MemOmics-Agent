...
when_to_use: "[query_gtopdb] GtoPdb药理学数据库查询：受体/通道/酶→配体/药物→结合亲和力→药理学参数"
version: 1.0.0
author: MemOmics
license: MIT
...
When you need query gtopdb analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `prompt` | [Required] Natural language query about drug targets/ligands/interactions (str) | |
