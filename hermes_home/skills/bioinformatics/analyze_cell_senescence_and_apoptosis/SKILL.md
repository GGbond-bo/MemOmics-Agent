...
when_to_use: "[analyze_cell_senescence_and_apoptosis] 细胞衰老与凋亡分析：流式/荧光数据→衰老/凋亡比例→药物诱导效应评估"
version: 1.0.0
author: MemOmics
license: MIT
...
When you need analyze cell senescence and apoptosis analysis

## Parameters

| Parameter | Default | Notes |
|-----------|---------|-------|
| `fcs_file_path` | [Required] Path to the FCS file containing flow cytometry data with measurements for senescence-associated β-galactosidase (SA-β-Gal) and Annexin V/7-AAD staining (str) | |
